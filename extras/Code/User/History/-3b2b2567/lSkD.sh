...
if [[ $user_agreed == "y" || $user_agreed == "Y" ]]; then
    ...
    case "$distro" in
        d) printf "${ACTION} - Installing zsh in your distro\n"
            package_man="apt install"
            ;;
        a) printf "${ACTION} - Installing zsh in your distro\n"
            package_man="pacman -S"
            ;;
        f) printf "${ACTION} - Installing zsh in your distro\n"
            package_man="dnf install"
            ;;
        o) printf "${ACTION} - Installing zsh in your distro\n"
            package_man="zypper install"
            ;;
        v) printf "${ACTION} - Installing zsh in your distro\n"
            package_man="xbps-install"
            ;;
        ob) printf "${ACTION} - Installing zsh in your distro\n"
            package_man="pkg_add"
            ;;
        fb) printf "${ACTION} - Installing zsh in your distro\n"
            package_man="pkg install"
            ;;
        r) printf "${ACTION} - Installing zsh in your distro\n"
