...
printf " -${ACT} Copying .zshrc and .p10k.zsh\n"
sleep 1
...
printf "${NOTE} - You can always configure the powerlevel10k theme with the \e[36m' p10k configure '\e[0m command in your termianal.\n"